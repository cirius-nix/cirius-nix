...
experiment.<br> Because of new version of Nix (24.11). All tasks are moved to
this [branch](https://github.com/cirius-nix/cirius-nix/tree/feat/24.11).
...
- Supported MacOS / NixOS. For MacOS, seamlessly integrated and managed Nix
  through [Nix-Darwin](https://github.com/LnL7/nix-darwin).
